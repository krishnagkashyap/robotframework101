...
runtime.oauth00107:: OAM Runtime OAuth::Client Creds:: Success
	...
	Set Base URL	&{Init}[oam.runtime.secure.baseurl]
	...
	${responseBody}	POSTHTTPS	&{test_data}[common.oauth.runtime.token.endpoint]
	HTTPSRESPONSEOK
...
runtime.oauth00108:: OAM Runtime OAuth::Access Token Validation FLOW: Client_Creds token:: Success
	...
	Create Logger	${testName}
	${responseBody}	GETHTTPS	&{test_data}[common.oauth.runtime.token.endpoint]/info
	HTTPSRESPONSEOK
...
runtime.oauth001019:: ROCF:: fail_006
	...
	Should Not Be Empty    ${e}
	Should Not Be Empty    ${ed}
	Should be equal as Strings    ${e}    &{test_data}[test102.runtime.errorCode.3]
...
runtime.oauth0105:: OAM Runtime OAuth::Access Token Validation FLOW:: Fail001
	...
	Write To Log	${responseBody}
	HTTPSRESPONSEBADREQUEST
	${err}    Get String    ${responseBody}    errorCode
	Should Not Be Empty    ${err}
	Should Be Equal As Strings    &{test_data}[test104.errorCode.1]    ${err}
