...
##########################################################################################################################
#    Set To Dictionary       ${3ldict}     3l.code.resource1_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=code&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&{test_data}[3l.scope.seperator]email&{test_data}[3l.scope.seperator]phone&{test_data}[3l.scope.seperator]address&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#    Set To Dictionary       ${3ldict}     3l.code.resource2_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=code&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.searchsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#   Set To Dictionary       ${3ldict}     3l.code.resource3_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=code&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#   Set To Dictionary       ${3ldict}     3l.code.resource4_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=code&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]RServer0.searchsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#    Set To Dictionary       ${3ldict}     3l.code.resource5_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=code&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
...
#    Set To Dictionary       ${3ldict}     3l.code.resource7_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=code&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=openid&{test_data}[3l.scope.seperator]profile&{test_data}[3l.scope.seperator]email&{test_data}[3l.scope.seperator]address&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#
##########################################################################################################################
#################The following variables are required for Positive Three-Legged flows response_type=token################
##########################################################################################################################
#    Set To Dictionary       ${3ldict}     3l.token.resource1_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&{test_data}[3l.scope.seperator]email&{test_data}[3l.scope.seperator]phone&{test_data}[3l.scope.seperator]address&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#    Set To Dictionary       ${3ldict}     3l.token.resource2_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.searchsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#   Set To Dictionary       ${3ldict}     3l.token.resource3_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#   Set To Dictionary       ${3ldict}     3l.token.resource4_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]RServer0.searchsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#    Set To Dictionary       ${3ldict}     3l.token.resource5_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
#    Set To Dictionary       ${3ldict}     3l.token.resource6_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]RServer0.searchsong&{test_data}[3l.scope.seperator]RServer0.uploadsong&{test_data}[3l.scope.seperator]RServer0.downloadsongs&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]
...
##########################################################################################################################
#    Set To Dictionary       ${3ldict}     3l.idtoken.resource1_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&{test_data}[3l.scope.seperator]email&{test_data}[3l.scope.seperator]phone&{test_data}[3l.scope.seperator]address&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#    Set To Dictionary       ${3ldict}     3l.idtoken.resource2_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.searchsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#   Set To Dictionary       ${3ldict}     3l.idtoken.resource3_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#   Set To Dictionary       ${3ldict}     3l.idtoken.resource4_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]RServer0.searchsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#    Set To Dictionary       ${3ldict}     3l.idtoken.resource5_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#    Set To Dictionary       ${3ldict}     3l.idtoken.resource6_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]RServer0.searchsong&{test_data}[3l.scope.seperator]RServer0.uploadsong&{test_data}[3l.scope.seperator]RServer0.downloadsongs&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#    Set To Dictionary       ${3ldict}     3l.idtoken.resource7_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=openid&{test_data}[3l.scope.seperator]profile&{test_data}[3l.scope.seperator]email&{test_data}[3l.scope.seperator]address&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#
##########################################################################################################################
##The following variables are required for Positive Three-Legged flows response_type=token id_token
##########################################################################################################################
#    Set To Dictionary       ${3ldict}     3l.tokenidtoken.resource1_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&{test_data}[3l.scope.seperator]email&{test_data}[3l.scope.seperator]phone&{test_data}[3l.scope.seperator]address&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#    Set To Dictionary       ${3ldict}     3l.tokenidtoken.resource2_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.searchsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#   Set To Dictionary       ${3ldict}     3l.tokenidtoken.resource3_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#   Set To Dictionary       ${3ldict}     3l.tokenidtoken.resource4_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]RServer0.searchsong&{test_data}[3l.scope.seperator]openid&{test_data}[3l.scope.seperator]profile&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#    Set To Dictionary       ${3ldict}     3l.tokenidtoken.resource5_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]openid&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
#    Set To Dictionary       ${3ldict}     3l.tokenidtoken.resource6_url=&{Init}[dc2.oam.runtime.baseurl]/oauth2/rest/authorize?response_type=id_token token&domain=&{iddomaindetails}[name]&client_id=&{clientdetails}[name]&scope=RServer0.playsong&{test_data}[3l.scope.seperator]RServer0.searchsong&{test_data}[3l.scope.seperator]RServer0.uploadsong&{test_data}[3l.scope.seperator]RServer0.downloadsongs&state=code1234&redirect_uri=&{3ldict}[oam.3l.vars.redirectURI0]&nonce=testidtoken
...
#
#    ${accesstoken}      ${refreshtoken}=     MDCOAUTHRUNTIME AUTHORIZATION_CODE GET ACCESSTOKEN AND REFERSHTOKEN      &{Init}[dc2.oam.runtime.baseurl]      &{iddomaindetails}[name]     &{clientdetails}[id]     &{clientdetails}[secret]     ${authzcode}      &{3ldict}[oam.3l.vars.redirectURI0]
#
#    ${response}=        MDCACCESS TOKEN VALIDATION FLOW    &{Init}[dc2.oam.runtime.baseurl]    &{iddomaindetails}[name]       ${accesstoken}
#
...
#
#    ${response_userinfo}=        MDCACCESS TOKEN VALIDATION USERINFO FLOW  &{Init}[dc2.oam.runtime.baseurl]    &{iddomaindetails}[name]       ${accesstoken}
...
#    ${accesstoken}      ${refreshtoken}=     MDCOAUTHRUNTIME AUTHORIZATION_CODE GET ACCESSTOKEN AND REFERSHTOKEN      &{Init}[dc2.oam.runtime.baseurl]      &{iddomaindetails}[name]     &{clientdetails}[id]     &{clientdetails}[secret]     ${authzcode}      &{3ldict}[oam.3l.vars.redirectURI0]
#
#    ${accesstoken_from_refreshtoken}=       MDCFETCH ACCESSTOKEN FROM REFRESH TOKEN FLOW   &{Init}[dc2.oam.runtime.baseurl]    &{iddomaindetails}[name]      &{clientdetails}[id]     &{clientdetails}[secret]    RServer0.playsong   ${refreshtoken}
#
#    ${response}=        MDCACCESS TOKEN VALIDATION FLOW    &{Init}[dc2.oam.runtime.baseurl]    &{iddomaindetails}[name]       ${accesstoken_from_refreshtoken}
#    Run Keyword And Ignore Error    Should Contain      ${response}     &{iddomaindetails}[name]    ignore_case=True
#    Run Keyword And Ignore Error    Should Contain      ${response}     &{clientdetails}[name]      ignore_case=True
#    Run Keyword And Ignore Error    Should Contain      ${response}     &{Init}[oam.admin.username]     ignore_case=True
##
...
#    ${accesstoken}      ${refreshtoken}=     MDCOAUTHRUNTIME AUTHORIZATION_CODE GET ACCESSTOKEN AND REFERSHTOKEN      &{Init}[dc2.oam.runtime.baseurl]     &{iddomaindetails}[name]     &{clientdetails}[id]     &{clientdetails}[secret]    ${authzcode}      &{3ldict}[oam.3l.vars.redirectURI0]
#
#    ${accesstoken_from_refreshtoken}=       MDCFETCH ACCESSTOKEN FROM REFRESH TOKEN FLOW   &{Init}[dc2.oam.runtime.baseurl]    &{iddomaindetails}[name]      &{clientdetails}[id]     &{clientdetails}[secret]    RServer0.searchsong   ${refreshtoken}
#
#    ${response}=        MDCACCESS TOKEN VALIDATION FLOW    &{Init}[dc2.oam.runtime.baseurl]    &{iddomaindetails}[name]       ${accesstoken_from_refreshtoken}
#    Run Keyword And Ignore Error    Should Contain      ${response}     &{iddomaindetails}[name]    ignore_case=True
#    Run Keyword And Ignore Error    Should Contain      ${response}     &{clientdetails}[name]      ignore_case=True
...
#
#    ${response}=        MDCACCESS TOKEN VALIDATION FLOW    &{Init}[dc2.oam.runtime.baseurl]    &{iddomaindetails}[name]       ${implicit_accesstoken}
#    Run Keyword And Ignore Error    Should Contain      ${response}     &{iddomaindetails}[name]    ignore_case=True
#    Run Keyword And Ignore Error    Should Contain      ${response}     &{clientdetails}[name]      ignore_case=True
#    Run Keyword And Ignore Error    Should Contain      ${response}     &{Init}[oam.admin.username]     ignore_case=True
#
#    ${response_userinfo}=        MDCACCESS TOKEN VALIDATION USERINFO FLOW  &{Init}[dc2.oam.runtime.baseurl]    &{iddomaindetails}[name]       ${implicit_accesstoken}
#    &{validUserInfoclaims}      create dictionary
#    Set To Dictionary       ${validUserInfoclaims}     profile=null
#    Set To Dictionary       ${validUserInfoclaims}     address=null
#    Set To Dictionary       ${validUserInfoclaims}     email=null
