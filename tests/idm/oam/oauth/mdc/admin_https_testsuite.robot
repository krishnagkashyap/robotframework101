...
oauth.admin00001:: OAM Admin OAuth::IdentityDomain Creation:: Success
	...
	${responseBody}	POSTHTTPS	&{test_data}[common.oauth.admin.identitydomain.rest.endpoint]
...
oauth.admin00013:: OAM Admin OAuth::OAuthIdentityDomain Get:: Success
	...
	${responseBody}	  GETHTTPS    &{test_data}[common.oauth.admin.identitydomain.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
oauth.admin0025:: OAM Admin OAuth::OAuthIdentityDomain Modify:: Success
	...
	${responseBody}	    PUTHTTPS    &{test_data}[common.oauth.admin.identitydomain.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
##IdentityDomain Creation POSTHTTPS
##http://aseng-wiki.us.oracle.com/asengwiki/display/ASQA/Single+Node+Server+with+Admin%2C+Runtime%2C+Issue+and+Validate
##Covers Single Node Server with Admin, Runtime, Issue and Validate FROM 49-54 on http for POSTHTTPS on ResourceServer
...
oauth.admin0049:: OAM Admin OAuth::ResourceServer Creation:: Success
	...
	${responseBody}	POSTHTTPS	&{test_data}[common.oauth.admin.resource.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
oauth0007:: OAM Admin OAuth::OAuthResourceServer Get:: Success
	...
	${responseBody}	  GETHTTPS    &{test_data}[common.oauth.admin.resource.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
oauth0006:: OAM Admin OAuth::ResourceServer Modify:: Success
	...
	Set Query Param    name    RobotTestResSvr2
	${responseBody}	    PUTHTTPS    &{test_data}[common.oauth.admin.resource.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
##IdentityDomain Creation POSTHTTPS
##http://aseng-wiki.us.oracle.com/asengwiki/display/ASQA/Single+Node+Server+with+Admin%2C+Runtime%2C+Issue+and+Validate
##Covers Single Node Server with Admin, Runtime, Issue and Validate FROM 97-102 on http for POSTHTTPS on OAuthClient
...
oauth0011:: OAM Admin OAuth::OAuthClient Get:: Success
	...
	${responseBody}	  GETHTTPS    &{test_data}[common.oauth.admin.client.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
oauth.admin0121:: OAM Admin OAuth::OAuthClient Modify:: Success
	...
	Set Query Param    name    RobotTestResSvr2
	${responseBody}	    PUTHTTPS    &{test_data}[common.oauth.admin.client.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
#IdentityDomain Creation POSTHTTPS
#http://aseng-wiki.us.oracle.com/asengwiki/display/ASQA/Single+Node+Server+with+Admin%2C+Runtime%2C+Issue+and+Validate
#Covers Single Node Server with Admin, Runtime, Issue and Validate FROM 133-138 on http for DELETEHTTPS on OAuthClient
...
oauth.admin0133:: OAM Admin OAuth::OAuthClient Deletion:: Success
	...
	Set Query Param    identityDomainName    robot01
	Set Query Param    name    testclient1
	${responseBody}	DELETEHTTPS    &{test_data}[common.oauth.admin.client.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
##IdentityDomain Creation POSTHTTPS
##http://aseng-wiki.us.oracle.com/asengwiki/display/ASQA/Single+Node+Server+with+Admin%2C+Runtime%2C+Issue+and+Validate
##Covers Single Node Server with Admin, Runtime, Issue and Validate FROM 85-90 on http for DELETEHTTPS on ResourceServer
...
oauth0008:: OAM Admin OAuth::ResourceServer Deletion:: Success
	...
	Set Query Param    identityDomainName    robot01
	Set Query Param    name    RobotTestResSvr2
	${responseBody}	DELETEHTTPS    &{test_data}[common.oauth.admin.resource.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
...
##IdentityDomain Creation POSTHTTPS
##http://aseng-wiki.us.oracle.com/asengwiki/display/ASQA/Single+Node+Server+with+Admin%2C+Runtime%2C+Issue+and+Validate
##Covers Single Node Server with Admin, Runtime, Issue and Validate FROM 37-42 on http for DELETEHTTPS on OAuthIdentityDomain
...
oauth.admin0037:: OAM Admin OAuth::OAuthIdentityDomain Deletion:: Success
	...
	Set Query Param    name    robot01
	${responseBody}	DELETEHTTPS    &{test_data}[common.oauth.admin.identitydomain.rest.endpoint]
	Write To Log	${responseBody}
	${status}	GETHTTPSStatus
	${actual}	Convert To String	${status}
